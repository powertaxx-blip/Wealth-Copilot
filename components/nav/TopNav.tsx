...
export function TopNav() {
  ...
  return (
    <header style={{ background: "var(--navy)", borderBottom: "1px solid var(--line)" }}>
      <div className="mx-auto flex max-w-[1180px] items-center gap-3 px-6 py-4">
        ...
        <div>
          <div className="text-lg font-semibold" style={{ color: "var(--paper, #fff)", fontFamily: "Source Serif 4, serif" }}>
            Power Taxx Ltd.
          </div>
          <div

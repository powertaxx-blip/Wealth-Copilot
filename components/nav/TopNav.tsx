...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/cashflow", emoji: "🌊", label: "Cash-Flow Forecast" },
      ...
      { href: "/credit", emoji: "💳", label: "Credit Health" },
  ...
  },
  {
    label: "Employers",
    items: [
      { href: "/employees", emoji: "🧑‍💼", label: "Employees & Payroll" },
      { href: "/contractors", emoji: "🛠️", label: "1099 Contractors" },
    ],
  },
  {
    label: "Fundraising",
  ...
  {
    label: "My Paycheck",
    items: [{ href: "/paycheckcheckup", emoji: "🩺", label: "Paycheck Checkup" }],
  },
  {
    label: "Account",
